 ...
 */
public class Programme10_TubeStationName {
    ...
    public static void main(String[] args) {
        ...
        zone1Stations.put("Oxford Circus", new ArrayList<>(List.of("Victoria line", "Central line", "Bakerloo Line")));
        zone1Stations.put("Wembley park", new ArrayList<>(List.of("Metropolitan Line", "Jubilee line")));
